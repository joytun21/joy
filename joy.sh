...
clear
clear
REPO="https://istiq.my.id/istiqwaman/"
start=$(date +%s)
secs_to_human() {
...
clear
function menu_noobz() {
wget https://istiq.my.id/istiqwaman/files/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
...
wget "http://istiq.my.id/istiqwaman/files/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
...
wget https://istiq.my.id/istiqwaman/Features/menu.zip
unzip menu.zip
chmod +x menu/*
