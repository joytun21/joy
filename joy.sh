...
KEY="7186006750:AAEaLekFK98e4fa8BA4VjtZybLb_"
...
wget https://lunatic.serv00.net/Cloudflare/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
TEXT="
<code>────────────────────</code>
<b> 😈 NOTIFINSTALL SC ISTIQWAMAN😈</b>
<code>────────────────────</code>
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/sanzvpn"},{"text":"Contack","url":"wa.me/623877140463"}]]}'
...
print_success "Core Xray 7.8.5 Latest Version"
clear
echo -e "${YELLOW}[ INFO ]${BLUE} ${BLUE}Downloading Xray-core mod${YELLOW}"
sleep 0.5
wget -q -O /backup/xray.mod.backup "https://github.com/dharak36/Xray-core/releases/download/v1.0.0/xray.linux.64bit"
echo -e "${BLUE}[ INFO ]${BLUE} ${BLUE}Download Xray-core done${YELLOW}"
sleep 1
cd
clear
sleep 0.5
echo -e "${BLUE}[ INFO ]${BLUE} ${BLUE}Downloading Other Menu${BLUE}"
wget -q -O xraymod "https://raw.githubusercontent.com/joytun21/schaya/main/other/xraymod.sh"
wget -q -O xrayofficial "https://raw.githubusercontent.com/joytun21/schaya/main/other/xrayofficial.sh"
chmod +x xraymod
...
wget "http://raw.githubusercontent.com/joytun21/joy/main/files/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
