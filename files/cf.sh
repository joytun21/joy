...
echo -e ""
#DOMAIN=szpremium.my.id
DOMAIN=szpremium.my.id
sub=${domen}
dns=${sub}.szpremium.my.id
#(</dev/urandom tr -dc a-z0-9 | head -c5)
#dns=${sub}.szpremium.my.id
#CF_ID=sanztunneling@gmail.com
#CF_KEY=5qElTaXLHGkoewfyUx1F4wekooNaX39CALT17KJC
dns=${sub}.szpremium.my.id
CF_KEY=5qElTaXLHGkoewfyUx1F4wekooNaX39CALT17KJC
CF_ID=sanztunneling@gmail.com
set -euo pipefail
...
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/user/${DOMAIN}/tokens/verify" \
